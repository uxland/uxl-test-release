"main";let invariant;_52c‍.w("../../src/invariant",[["invariant",["invariant"],function(v){invariant=v}]]);let assert,expect;_52c‍.w("chai",[["assert",["assert"],function(v){assert=v}],["expect",["expect"],function(v){expect=v}]]);let sinon;_52c‍.w("sinon",[["*",null,function(v){sinon=v}]]);
